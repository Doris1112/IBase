...
class Poetry {
    ...
    static List<Poetry> getPoetry() {
        try {
            return new Gson().fromJson(JSON, new TypeToken<List<Poetry>>(){}.getType());
        } catch (Exception e) {
            e.printStackTrace();
        }
        return null;
    ...
    static Poetry getPoetry1(){
        Poetry poetry = new Poetry();
        poetry.setTitle("句");
        poetry.setContent("未离海底千山黑，才到天中万国明。");
        poetry.setAuthors("宋太祖");
        return poetry;
    }
}
